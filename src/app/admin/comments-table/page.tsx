...
import { getAllComments } from "@/apiCalls/articleApiCall";
...
export default async function commentsPage() {
  ...
  return (
    <section className="p-5">
      <h1 className="mb-7 text-2xl font-semibold text-gray-400">Comments</h1>
        ...
        <tbody>
          {comments.map((comment) => (
            <tr key={comment.id} className="border-b border-t border-gray-300">
              <td className="p-3 text-gray-400">{comment.text}</td>
              <td className="text-gray-400 p-3 font-normal hidden lg:inline-block">
